...
const ProductDetailWithCSSModules = () => {
        ...
        <Box className={styles.productInfo}>
          ...
          <Box className={styles.priceContainer}>
            ...
            (product as Product).originalPrice ? (
              ...
              <Typography variant="h5" className={styles.regularPrice}>
                ₪{product.price}
              </Typography>
            )}
          </Box>
          ...
          <Box className={styles.quantityCartContainer}>
            <QuantitySelector
              quantity={quantity}
...
export default ProductDetailWithCSSModules;
